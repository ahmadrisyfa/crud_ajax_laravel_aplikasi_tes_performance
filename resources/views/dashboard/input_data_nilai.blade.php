...
<div class="pagetitle">
  ...
  <section class="section profile">
    ...
    <form action="{{url('input_data_nilai')}}" method="POST">
      @csrf
      ...
      {{-- <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_lari" class="form-control" id="nilai_lari" required >
          </div>
        </div> --}}
        <div class="col-12">
          <label for="yourUsername" class="form-label"><b>Hasil Nilai Lari</b> </label>
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_lari" class="form-control" id="hasil_nilai_lari" >
          </div>
        </div>  
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_pull_up" class="form-control" id="nilai_pull_up" required >
          </div>          
        </div> --}}
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_pull_up" class="form-control" id="hasil_nilai_pull_up" >
          </div>
        </div>
        ...
        {{-- <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_sit_up" class="form-control" id="nilai_sit_up" required >
          </div>          
        </div> --}}
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_sit_up" class="form-control" id="hasil_nilai_sit_up" >
          </div>
        </div>
        ...
        {{-- <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_push_up" class="form-control" id="nilai_push_up" required >
          </div>          
        </div> --}}
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_push_up" class="form-control" id="hasil_nilai_push_up" >
          </div>
        </div>
        ...
        {{-- <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_shuttle_run" class="form-control" id="nilai_shuttle_run" required >
          </div>          
        </div> --}}
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_shuttle_run" class="form-control" id="hasil_nilai_shuttle_run" >
          </div>
        </div>
        ...
        {{-- <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_renang_dada" class="form-control" id="nilai_renang_dada" required >
          </div>          
        </div> --}}
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_renang_dada" class="form-control" id="hasil_nilai_renang_dada">
          </div>
        </div>
        ...
        {{-- <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="number" name="nilai_renang_bebas" class="form-control" id="nilai_renang_bebas" required >
          </div>          
        </div> --}}
        <div class="col-12">
          <label for="yourUsername" class="form-label"><b>Nilai Garjas A</b></label>
          <div class="input-group has-validation">
            <input required type="text" name="nilai_garjas_A" class="form-control" id="nilai_garjas_A">
          </div>
        </div>
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input required type="text" name="nilai_garjas_B" class="form-control" id="nilai_garjas_B">
          </div>
        </div>
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input required type="text" name="total_nilai_garjas" class="form-control" id="total_nilai_garjas">
          </div>
        </div>
        ...
        <div class="col-12">
          ...
          <div class="input-group has-validation">
            <input type="text" name="hasil_nilai_renang_bebas" class="form-control" id="hasil_nilai_renang_bebas">
          </div>
        </div>
