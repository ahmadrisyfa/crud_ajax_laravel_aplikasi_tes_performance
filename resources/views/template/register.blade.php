                ...
                <div class="card-body">
                  ...
                  <form class="row g-3" action="{{url('register')}}" method="POST" >
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          <input type="text" name="ttl" class="form-control" id="yourUsername" required>
                          {{-- <div class="invalid-feedback">Please enter your username.</div> --}}
                        </div>
                      </div>
                      <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          <input type="number" name="no_hp" class="form-control" id="yourUsername" required>
                          {{-- <div class="invalid-feedback">Please enter your username.</div> --}}
                        </div>
                      </div>
                      <div class="col-12">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          <textarea type="text" name="alamat" class="form-control" id="yourUsername" required></textarea>
                          {{-- <div class="invalid-feedback">Please enter your username.</div> --}}
                        </div>
                      </div>
                    <div class="col-12">
